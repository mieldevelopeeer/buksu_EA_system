...
import { X, FileText, User, CheckCircle, Clock, Users, CalendarCheck } from 'lucide-react';

export default function SubmittedRequirements({ students = [] }) {
  ...
  const metrics = useMemo(() => {
    ...
    students.forEach((student) => {
      ...
      if (submittedCount > 0) withSubmissions++;
    ...
    return {
      ...
      visibleStudents,
      fullyCompliant,
      pendingStudents: totalStudents - fullyCompliant,
      completionRate,
    };
      ...
      <div className="p-6 text-xs text-gray-800 space-y-4">
        <header className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="text-[11px] text-gray-500">Monitor submitted enrollment requirements across all students.</p>
          </div>
        ...
        <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          <div className="rounded-xl border border-blue-100 bg-white/80 p-4 shadow-sm">
            ...
            <p className="mt-1 text-[11px] text-gray-500">Overall learners tracked for requirements.</p>
          </div>
          <div className="rounded-xl border border-emerald-100 bg-white/80 p-4 shadow-sm">
            ...
            <p className="mt-1 text-[11px] text-gray-500">Finished submitting all required documents.</p>
          </div>
          <div className="rounded-xl border border-amber-100 bg-white/80 p-4 shadow-sm">
            ...
            <p className="mt-1 text-[11px] text-gray-500">Students still missing at least one requirement.</p>
          </div>
          <div className="rounded-xl border border-indigo-100 bg-white/80 p-4 shadow-sm">
            ...
            <p className="mt-1 text-[11px] text-gray-500">Percentage of submitted documents vs total required.</p>
          </div>
        </section>
            ...
            <div className="relative w-full max-w-md max-h-[85vh] overflow-y-auto rounded-2xl border border-gray-200 bg-white p-6 shadow-xl">
              ...
              <header className="flex flex-col items-center gap-3 text-center">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[11px] text-gray-500">Student #{selectedStudent.id}</p>
                </div>
              </header>
                    ...
                    <li key={requirement.id} className="rounded-lg border border-gray-200 bg-gray-50 p-3 shadow-sm">
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`ml-auto text-xs font-semibold ${
                          requirement.is_submitted ? 'text-emerald-600' : 'text-rose-600'
                        }`}>
